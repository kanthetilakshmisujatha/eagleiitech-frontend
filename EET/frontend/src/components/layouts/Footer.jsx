        ...
        <div className="text-center md:text-left">
          ...
          <ul className="wrapper mt-5 justify-center md:justify-start">
            <li className="icon linkedin">
              <span className="tooltip">LinkedIn</span>
              <a
                href="https://www.linkedin.com/company/eagle-eye-technologies-llc/?viewAsMember=true" // Replace with your actual LinkedIn URL
                target="_blank"
                rel="noopener noreferrer"
                className="block hover:text-[#F54A00] transition-colors"
              >
                <svg
                  viewBox="0 0 448 512"
                  height="1.2em"
            ...
            <li className="icon facebook">
              <span className="tooltip">Facebook</span>
              <a
                href="https://www.facebook.com/people/Eagle-Eye-Tech/61555907854696/?mibextid=LQQJ4d" // Replace with your actual Facebook URL
                target="_blank"
                rel="noopener noreferrer"
                className="block hover:text-[#F54A00] transition-colors"
              >
            ...
            <li className="icon instagram">
              <span className="tooltip">Instagram</span>
              <a
                href="https://www.instagram.com/eagleeyetechnologies" // Replace with your actual Instagram URL
                target="_blank"
                rel="noopener noreferrer"
                className="block hover:text-[#F54A00] transition-colors"
              >
