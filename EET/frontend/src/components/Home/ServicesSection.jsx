...
const ServicesSection = () => {
  ...
  useEffect(() => {
    ...
    // Animate subtitle with slight rotation and fade
    gsap.fromTo(
      subtitleRef.current,
    ...
    // Animate cards with staggered slide-in and rotation
    gsap.fromTo(
      cardsRef.current,
      {
        y: 100,
    ...
    // Animate navigation arrows (fade and slide from sides)
    gsap.fromTo(
    ...
    // Animate navigation indicators (fade and slide up)
    gsap.fromTo(
    ...
    cardsRef.current.forEach(card => {
      ...
      card.addEventListener('mouseenter', () => {
        ...
        gsap.to(button, {
          scale: 1.05,
          background: 'linear-gradient(45deg, #F54A00, #FF6B6B)',
          duration: 0.3,
          ease: 'power2.out',
        });
      });
      ...
      card.addEventListener('mouseleave', () => {
        ...
        gsap.to(button, {
          scale: 1,
          background: 'linear-gradient(45deg, #FF6B6B, #F54A00)',
          duration: 0.3,
          ease: 'power2.out',
        });
      });
  ...
  const services = [
    ...
    {
      title: 'Staffing',
      description: 'Eagle Eye Tech has been connecting fresh talent with companies from around the world.',
      image: '/sattf.png',
    ...
    {
      title: 'Digital Marketing',
      description: 'Going beyond boundaries, our marketing strategies reach the right audience, leveraging the ROI of a business.',
      image: '/digital marketing.webp',
      link: '/searchengine',
    },
  ];
  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 py-16 md:py-24 px-4 text-center overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 md:mb-16 lg:mb-20">
          <h2 className="text-sm md:text-base font-semibold text-[#F54A00] uppercase tracking-wide mb-3 md:mb-4">
            #OUR SERVICES
          ...
          <h1 
            ref={titleRef}
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-5 leading-tight"
          >
            We Are Just Getting Started
          </h1>
          <p 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {getVisibleServices().map((service, index) => (
              <div
                key={index}
                ref={addToCardsRef}
                className="group bg-gray-800/50 backdrop-blur-md p-6 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-700/50 relative overflow-hidden"
              >
                <div className="card-circle absolute w-80 h-80 bg-gradient-to-br from-[#F54A00]/30 to-[#FF6B6B]/30 rounded-full -top-40 -left-40 opacity-40 transition-all duration-500"></div>
                
                <div className="relative z-10">
                  <div className="overflow-hidden rounded-xl mb-5 border border-gray-600/20">
                    <img 
                      src={service.image} 
                      alt={service.title} 
                      className="service-image w-full h-48 md:h-52 object-cover rounded-xl transition-transform duration-500"
                  ...
                  <h3 className="service-title text-xl md:text-2xl font-bold text-white mb-3 transition-colors duration-300">
                    {service.title}
                  </h3>
                  
                  <p className="text-gray-300 text-sm md:text-base mb-5 leading-relaxed min-h-[72px]">
                    {service.description}
                  </p>
                  ...
                  <div className="flex justify-center">
                    <a 
                      href={service.link} 
                      className="read-more-btn inline-flex items-center px-4 py-2 text-white font-semibold bg-gradient-to-r from-[#FF6B6B] to-[#F54A00] rounded-full hover:from-[#F54A00] hover:to-[#FF6B6B] transition-all duration-300 group-hover:shadow-lg cursor-pointer"
                    >
                      Read More
                      <svg className="w-4 h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
